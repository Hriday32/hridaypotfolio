...
export default function ProjectDetailPage() {
  ...
  return (
    <>
      <section
        className={`min-h-screen ${bgGradient} ${textColor} px-4 sm:px-8 py-12 transition-colors duration-500`}
      >
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            >
              <div
                className={`p-2 rounded-lg ${cardBg} ${borderColor} border group-hover:scale-110 transition-transform`}
              >
                  ...
                  <div className="flex items-center gap-4 flex-wrap">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      {project.liveLink && (
                        ...
                        >
                          <div
                            className={`p-2 rounded-lg ${cardBg} border border-orange-500/30`}
                          >
            ...
            <motion.div variants={itemVariants} className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {project.images.map((image, i) => (
                  ...
                  >
                    <div
                      className={`relative overflow-hidden rounded-xl shadow-2xl border ${borderColor} ${hoverBorder} transition-all duration-300 h-48 sm:h-56`}
                    >
                      <Image
                        src={image.src}
            ...
            <div className="space-y-8">
              ...
              {project.goal && (
                <motion.div variants={itemVariants}>
                  ...
                  <div
                    className={`rounded-xl p-6 border ${borderColor} ${cardBg} backdrop-blur-sm`}
                  >
                    <p className={`leading-relaxed text-lg ${textMuted}`}>
                      {project.goal}
                    </p>
                  </div>
                </motion.div>
