...
interface Experience {
  ...
  description: string[];
  technologies: string[];
  type: "full-time" | "part-time" | "contract" | "freelance" | "developer";
  logo?: string;
  website?: string;
  achievements?: string[];
}
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        >
          ...
          <p className={`${subTextColor} mt-4 text-lg  max-w-2xl mx-auto`}>
            My professional journey through the tech industry, building
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          >
            <div
              className={`rounded-2xl p-6 backdrop-blur-sm border ${borderColor} sticky top-24`}
            >
                    ...
                    index === activeTab && (
                      <div key={experience.id} className="space-y-6">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                          <div className="flex-1">
                            ...
                            <div className="flex flex-wrap items-center gap-4 mt-4">
                              ...
                              <div
                                className={`px-3 py-1 rounded-full border text-xs font-medium ${getTypeColor(experience.type)}`}
                              >
                        ...
                        <div className="space-y-4">
                          <h4
                            className={`font-semibold flex items-center gap-2 ${textColor}`}
                          >
                            <ChevronRight
                              size={16}
                              className={
