  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1
          className={`text-4xl  md:text-7xl lg:leading-tight lg:tracking-wider ${textColor}`}
        >
          I&apos;m{" "}
      ...
      <div className="relative z-10 max-w-7xl w-full flex flex-col md:flex-row items-center justify-between  md:gap-16 md:mt-30">
        ...
        >
          <div
            className={`relative w-[28rem] h-[32rem] md:w-[34rem] md:h-[34rem] rounded-t-full ${circleColor} transition-colors duration-500`}
          ></div> */}
        ...
        {/* <Image
            ...
            height={1000}
            priority
            className={`absolute -translate-y-60 z-10 object-cover scale-110 transition-transform duration-500 ${imageFilter}`}
          />
        </div> */}
        <div
        ...
        >
          <div
            className={`flex justify-center md:justify-end gap-1 ${
