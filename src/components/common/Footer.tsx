...
export default function Footer({
  phoneNumber = "+977 9819604968",
  email = "itsmeramhriday@gmail.com",
  linkedinUrl = "https://www.linkedin.com/in/ram-hriday-mahato/",
  githubUrl = "https://github.com/Hriday32",
  twitterUrl = "",
  ...
  const recipient = "itsmeramhriday@gmail.com";
  ...
  const socialLinks = [
    {
      icon: <Icon icon="skill-icons:linkedin" width="256" height="256" />,
      href: linkedinUrl,
      label: "LinkedIn",
    ...
    {
      icon: (
        <Icon icon="ant-design:github-outlined" width="1024" height="1024" />
      ),
      href: githubUrl,
      label: "GitHub",
  ...
  "
        >
          ...
          <div className="text-center sm:text-left">
            <h3 className="text-xl font-bold mb-4">Ram Hriday</h3>
            <p className={`${subTextColor} mb-6 max-w-md mx-auto sm:mx-0`}>
              Frontend Developer passionate about creating impactful digital
              experiences.
            </p>
            ...
            <div className="space-y-4">
              {contactInfo.map((contact, i) => (
                <motion.a
                  ...
                  whileHover={{ x: 5 }}
                >
                  <div className={`p-2 rounded-lg ${hoverColor}`}>
                    {contact.icon}
                  </div>
            ...
            <div className="space-y-3">
              {navLinks.map((link) => (
                <motion.div
                  key={link.name}
                  whileHover={{ x: 5 }}
                  className={`block ${subTextColor} text-sm transition-colors duration-300`}
                >
          ...
          <div className="text-center sm:text-left">
            ...
            <div className="p-4 rounded-2xl border border-gray-800 bg-white/5">
              ...
              <p className="text-gray-400 text-sm mb-4">
                Currently accepting new projects and opportunities for{" "}
                {currentYear}
              </p>
        ...
        {/* Bottom Bar */}
        <div className="border-t border-gray-800 flex flex-col md:flex-row justify-between text-sm text-gray-500 py-6 ">
          <div>© {currentYear} Ram Hriday. Built with Next.js</div>
    ...
    ${isDark ? "bg-neutral-900/60 text-gray-300 hover:text-blue-400" : `bg-white/60 text-gray-700 ${hoverColor}`}`}
          ...
          whileTap={{ scale: 0.95 }}
        >
          <Icon icon="skill-icons:linkedin" width="256" height="256" />
        </motion.a>
