...
export default function ResumeSection() {
  ...
  const resumeUrl = "/Ram_Hriday_Mahato_CV_Resume.pdf";
  ...
  const handleDownload = () => {
    ...
    link.href = resumeUrl;
    link.download = "Ram_Hriday_Mahato_CV_Resume.pdf";
  ...
  return (
    <section
      className={`min-h-screen ${bgColor} ${textColor} px-4 sm:px-8 py-12 transition-colors duration-500`}
    >
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          >
            <div
              className={`rounded-2xl p-6 ${cardBg} ${borderColor} border backdrop-blur-sm`}
            >
              <div className="flex items-center gap-3 mb-4">
                <div
                  className={`p-2 rounded-lg ${isDark ? "bg-orange-500/20" : "bg-orange-100"} border ${isDark ? "border-orange-500/30" : "border-orange-200"}`}
                >
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <span className={textMuted}>itsmeramhriday@gmail.com</span>
                </div>
                <div className="flex items-center gap-3">
                  <FaPhone className="w-4 h-4 text-orange-500" />
                  <span className={textMuted}>9819604968</span>
                </div>
                <div className="flex items-center gap-3">
            ...
            >
              ...
              <div className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className={textColor}>~1 MB</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <span className={textColor}>february 2025</span>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <ul className={`space-y-2 text-sm ${textMuted}`}>
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    Click &quot;Open in New Tab&quot; for better viewing
                  </span>
                </li>
                <li className="flex items-start gap-2">
          ...
          <motion.div variants={itemVariants} className="lg:col-span-2">
            ...
            >
              <div className="flex items-center justify-between mb-6">
                ...
                <span
                  className={`px-3 py-1 rounded-full text-sm font-medium ${isDark ? "bg-orange-500/20 text-orange-400" : "bg-orange-100 text-orange-600"} border ${isDark ? "border-orange-500/30" : "border-orange-200"}`}
                >
                  PDF Document
                </span>
              </div>
              ...
              <div className="relative">
                {isLoading && (
                  <div
                    className={`absolute inset-0 flex items-center justify-center rounded-xl ${isDark ? "bg-gray-800" : "bg-gray-200"}`}
                  >
                ...
                <div
                  className={`rounded-xl overflow-hidden border-2 ${borderColor} shadow-2xl ${isLoading ? "opacity-0" : "opacity-100"} transition-opacity duration-300`}
                >
                  <iframe
                    src={`${resumeUrl}#view=fitH`}
                    className="w-full h-[600px] sm:h-[700px] md:h-[800px]"
                    title="Ram Hriday Mahato Resume"
                    onLoad={handleLoad}
                    onError={handleError}
                  />
                </div>
